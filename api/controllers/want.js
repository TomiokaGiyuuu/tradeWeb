const flats = require("../data");

//const flats = require("../newData");
const wantsTwoPerson = (req, res) => {
...
const wantsThreePerson = (req, res) => {
